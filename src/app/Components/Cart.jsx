      ...
      {Cart.length === 0 ? (
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="w-full">
            <Summary totalBook={totalBook} AvgDuartion={AvgDuartion} />
          </div>
        </div>
      )}
    </div>
...
export const Summary=({totalBook,AvgDuartion})=>{
  ...
  <div className="space-y-2">
    ...
    <NavLink to="/catalog" className="block text-center text-sm text-gray-600 hover:underline">
      Continue Browsing
    </NavLink>
  </div>
